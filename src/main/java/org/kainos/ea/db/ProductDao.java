...
public class ProductDao {
    ...
    public int createProduct(ProductRequest product) throws SQLException{
        ...
        String inputStatement = "INSERT INTO Product(Name, Description, Price) VALUES(?, ?, ?);";
    ...
    public void updateProduct(int id, ProductRequest product) throws SQLException {
        ...
        String inputStatement = "UPDATE Product SET Name = ?, Description = ?, Price = ? WHERE ProductID = " + id + ";";
